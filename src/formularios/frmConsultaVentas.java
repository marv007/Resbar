...
public class frmConsultaVentas extends javax.swing.JFrame {
    ...
    private void filtrado(){
        if(cmbFiltro.getSelectedItem().equals("Día")){
            tablaDia();
        }
    }
    ...
    private void initComponents() {
        ...
        jComboBox3.setFont(jComboBox3.getFont().deriveFont(jComboBox3.getFont().getStyle() | java.awt.Font.BOLD, jComboBox3.getFont().getSize()+9));
        ...
        cmbFiltro.setFont(cmbFiltro.getFont().deriveFont(cmbFiltro.getFont().getStyle() | java.awt.Font.BOLD, cmbFiltro.getFont().getSize()+9));
        cmbFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Día", "Mes", "Año" }));
